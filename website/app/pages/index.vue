...
<template>
  <main>
    <section id="home" class="w-full shadow-lg">
      ...
      <div class="mx-auto max-w-6xl px-6 pb-20 flex justify-center h-[400px] md:h-[656px]">
    ...
    <section id="reserveren" class="w-full shadow-lg">
      <div class="mx-auto max-w-6xl px-6 py-20 flex flex-col gap-10">
        ...
        <div class="flex flex-col md:flex-row gap-10">
          <div
            class="flex flex-col lg:flex-row gap-6 flex-1 border-4 border-gray-700 relative p-10"
          >
  ...
  <footer class="w-full py-6">
    <div
      class="flex flex-col sm:flex-row gap-3 mx-auto max-w-6xl px-6 sm:justify-between items-center"
    >
      <div class="copyright">
