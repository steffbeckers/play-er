...
<template>
  <header class="main w-full px-6 shadow-xl">
    <div class="mx-auto max-w-6xl">
      <header class="flex justify-between h-20">
        <a href="#" class="flex pe-8">
          <img src="~/assets/images/P_Dark.svg" alt="Play-ER Icon" width="56" />
        </a>
        <nav class="main flex text-white items-center gap-6">
        ...
        <div class="social-media flex items-center gap-6">
          <!-- TODO: Correct URL? -->
          <a href="https://www.facebook.com/play-er" target="_blank" rel="noopener noreferrer">
            <svg
              width="32"
              height="32"
              viewBox="0 0 32 32"
          ...
          <!-- TODO: Correct URL? -->
          <a href="https://www.instagram.com/play-er" target="_blank" rel="noopener noreferrer">
            <svg
              width="32"
              height="32"
              viewBox="0 0 32 32"
  ...
  <section id="reserveren" class="w-full p-20">
    <div class="mx-auto max-w-6xl">
      <h1 class="">RESERVEREN</h1>
    </div>
  </section>
  ...
  <section id="games" class="w-full p-20">
    <div class="mx-auto max-w-6xl">
      <h1>GAMES</h1>
    </div>
  </section>
  <section id="clubs" class="w-full p-20">
    <div class="mx-auto max-w-6xl">
      <h1>CLUBS</h1>
    </div>
  </section>
  <footer class="main w-full py-6">
    <div class="flex mx-auto max-w-6xl justify-between">
      <span class="copyright"
        >&copy; {{ new Date().getFullYear() }} Play-ER. Alle rechten voorbehouden.</span
      >
